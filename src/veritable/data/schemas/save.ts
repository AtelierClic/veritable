...
// political capital, legitimacy, coups, objectives, notes).
//
...
// version: freeze this file as saveV4.ts, write the new one here, and add
// migrations/v4-to-v5.ts (ARCHITECTURE.md, invariant 2).
//
// Pieces imported from saveV1.ts / saveV2.ts / saveV3.ts are unchanged since
// then; those files are frozen, so a piece that must change is redefined
...
export const SaveHeaderSchema = SaveHeaderV4Schema;
export type SaveFile = SaveFileV4;
export type JournalEntry = JournalEntryV4;
export const JOURNAL_KINDS = JOURNAL_KINDS_V4;
